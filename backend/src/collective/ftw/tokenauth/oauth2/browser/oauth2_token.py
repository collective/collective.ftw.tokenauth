...
from collective.ftw.tokenauth.oauth2.exceptions import VerificationError
...
from collective.ftw.tokenauth.permissions import ImpersonateUser
...
class OAuth2TokenEndpoint(BrowserView):
    ...
    *extension grant* as described in
    ...
    def get_potential_service_key(self, assertion):
        ...
        unverified_claimset = jwt.decode(assertion, options={"verify_signature": False})
