...
# tokenauth build configuration file
...
linkcheck_ignore = [
    ...
    r"https://github.com/collective/tokenauth/issues/new",  # requires auth
...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/collective/tokenauth",
    ...
    "repository_url": "https://github.com/collective/tokenauth",
...
# html_context = {
#     "edit_page_url_template": "https://github.com/collective/tokenauth/edit/main/docs/",
# }
...
ogp_site_name = "tokenauth Documentation"
ogp_type = "website"
...
htmlhelp_basename = "tokenauthDocumentation"
...
latex_documents = [
    (
        "index",
        "tokenauthDocumentation.tex",
        "tokenauth Documentation",
