...
myst:
  html_meta:
    "description": "tokenauth how-to guides"
    "property=og:description": "tokenauth how-to guides"
    "property=og:title": "tokenauth how-to guides"
    "keywords": "Plone, tokenauth, how-to, guides"
---
...
![Manage Service Keys](/_static/manage-service-keys.png)
...
![Issue Service Key](/_static/issue-service-key.png)
...
## Create and sign JWT authorization grant using service key
